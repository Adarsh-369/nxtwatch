...
class VideoDetailView extends Component {
    ...
    formattedData = data => ({
        id: data.video_detaild.id,
        title: data.video_details.title,
        videoUrl: data.video_details.video_url,
        thumbnailUrl: data.video_details.thumbnail_url,
        viewCount: data.video_details.view_count,
        publishedAt: data.video_detaild.published_at,
        description: data.video_detaild.description,
    ...
    getVideoDetails = async () => {
        this.setSate({apiStatus: apiStatusConstants.inProgress})
